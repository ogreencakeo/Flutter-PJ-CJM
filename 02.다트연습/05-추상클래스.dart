...
// 일반 상속은 부모클래스의 모든 내용을 재정의 할 필요가 없음!
// - 단, 구체적인 정의가 없는 메서드는 필수 재정의!!
class JeeHyun extends Saram{
  // 생성자 : 받은 값을 부모클래스로 넘겨 먼저 셋팅함!
...
// 박서준 배우의 클래스 //////////////////
// 남자 추상클래스를 상속받는다
// 추상클래스를 일반 상속한 클래스는 추상클래스의 미정의 메서드를 
...
// 에만 다중 상속을 하도록 제안할 수 있다
// on Namja라는 것은 남자 클래스를 상속한 경우만 믹스인 사용!
// -> 결과적으로 남자가수에만 사용가능!
