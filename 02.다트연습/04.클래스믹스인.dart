...
void main(List<String> args) {
  ...
  print('개발인스턴스 광도 : ${light.luminosity}');

  // 컴포지션 방법으로 다른 클래스 사용하기
  // 현대 생성시 K엔진 클래스를 내부에 생성함!
  HyunDai hd = HyunDai(K_Engine());
  print('현대차 엔진 파워 hd.k_engine.power : ${hd.k_engine.power}');
  print('현대차 엔진 주행거리 hd.k_engine.distance : ${hd.k_engine.distance}');
} // main ///////////////
