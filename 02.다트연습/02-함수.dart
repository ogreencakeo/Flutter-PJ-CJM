void main(List<String> args) {
  ...
  /*********************************************************************** 
    ...
    3. 람다함수 : 함수형 변수로 선언 후 화살표로 리턴/실행 코드 작성
    형식 : Function 함수명 = (전달변수) => 코드;
    -> 특징 : return 키워드 없어도 자동 리턴 처리됨!
  ...
  ***********************************************************************/
  ...
  showTxt('공유의 취미는 ${recommActor['공유']?['취미']}다! 사는 곳은 ${
    recommActor['공유']?['사는 곳']}다! 공유의 자동차는 ${recommActor['공유']?['자동차']?? '정보없음'}다!');
